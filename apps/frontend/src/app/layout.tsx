  ...
  return (
    <html lang="id">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Space+Mono:wght@400;700&family=DM+Sans:wght@400;500;700&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
        ...
        <header className="topbar">
          <div className="topbar-logo">
            X-TRAORDINARY <span>GROW WITH HEART</span>
          </div>
