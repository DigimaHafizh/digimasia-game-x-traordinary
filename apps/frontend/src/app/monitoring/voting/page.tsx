    ...
    return (
        <main className={styles.adminContainer} style={{ padding: '4rem' }}>
            <header style={{ marginBottom: '4rem', textAlign: 'center' }}>
                <h1 className="gradient-text" style={{ fontSize: '4rem', margin: 0 }}>LIVE VOTING MONITOR</h1>
                <p style={{ opacity: 0.6, letterSpacing: '4px', fontWeight: 800 }}>X-CELERATE THE TREE — REAL-TIME PARTICIPATION</p>
            </header>
